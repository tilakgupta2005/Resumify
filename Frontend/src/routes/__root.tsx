    ...
    head: () => ({
      ...
      meta: [
        ...
        { name: "viewport", content: "width=device-width, initial-scale=1" },
        {
          name: "description",
          content:
            "Resumify helps you craft ATS-friendly resumes, manage your professional profile, and generate tailored resumes for any job description.",
        },
        {
          property: "og:title",
